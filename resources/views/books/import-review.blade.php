    ...
    <div class="row">
        <div class="col-md-12">
            <ul class="breadcrumb">
                ...
                <li><a style="color: violet;" href="{{ url('/admin/books/create') }}">Tambah Buku</a></li>
                <li style="color: green;" class="active">Review Buku</li>
            </ul>
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h2 style="color: green;" class="panel-title">Review Buku</h2>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {!! Form::open(['url' => route('books.destroy', $book->id),
                                            ...
                                            'data-confirm'  =>  'Yakin ingin menghapus ' . $book->title . '?',
