            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="app-navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        @if (Auth::guest())
                            <li><a style="color:skyblue;" href="{{ route('login') }}">Login</a></li>
                            <li><a style="color:skyblue;" href="{{ route('register') }}">Daftar</a></li>
                        @else
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li><a style="color:skyblue;" href="{{ url('settings/password') }}"><i class="fa fa-btn fa-lock"></i> Ubah Password</a></li>
                                    <li>
                                        <a style="color:skyblue;" href="{{ route('logout') }}"
